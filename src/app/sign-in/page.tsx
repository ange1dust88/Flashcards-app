        ...
        <div className='flex justify-center items-center border-r border-neutral-800'>
          <div className='max-w-80 w-full'>
            <form 
              ...
              <p className="text-md text-neutral-400 text-center">Enter your data to login</p>
              ...
              <Button 
                className='w-full' 
                variant={'outline'} 
                onClick = {()=> router.push('/sign-up')}>Create account</Button>
              
              {error ? (
                <div className="bg-linear-to-br border text-red-500 text-sm border-red-800 rounded-md px-2 py-0.5 from-red-700/30 mt-2">{error}</div>
              ):
              (
                <></>
              )}
